...
class Enemy {
    ...
    draw(ctx) {
        ...
        let cols = 7; // Revert to original 7-column grid
        let rows = 3;
        ...
        if (img) {
            ...
            ctx.imageSmoothingEnabled = true; // 원래대로 복구
            ctx.restore();
        }
        // 적 체력 바 (요청 사항: 상단에 표시)
        if (this.state !== 'DEAD') {
...
const BOSS2_SPRITE_MAP = {
    ...
    ATTACK: {
        ...
        hitFrame: 3,
        frames: [
            { x: 300, w: 232 }, { x: 532, w: 232 }, { x: 754, w: 232 },
            { x: 1000, w: 232 }, { x: 1232, w: 232 }, { x: 1464, w: 232 }
        ]
    },
    DEAD: {
        y: 426, h: 213,
        frames: [
            { x: 280, w: 232 }, { x: 512, w: 232 }, { x: 734, w: 232 },
            { x: 976, w: 232 }, { x: 1208, w: 232 }, { x: 1440, w: 232 }
        ]
    }
};
...
const BOSS_KING_SPRITE_MAP = {
    ...
    ATTACK: {
        ...
        hitFrame: 4,
        frames: [
            { x: 300, w: 232 }, { x: 532, w: 232 }, { x: 724, w: 232 },
            { x: 986, w: 232 }, { x: 1218, w: 232 }, { x: 1450, w: 232 }
        ]
    },
    DEAD: {
        y: 426, h: 213,
