...
// 보스2 (청토끼 보스2.png) - 3x6 그리드, 고딕 스팀펑크 토끼 사이보그
// Row 1 (y=0):    걷기 (Walk) - 6프레임: 기계적 보행, 증기 분출
// Row 2 (y=140):  공격 (Attack) - 6프레임: 톱날 팔 슬램, 파편 폭발
// Row 3 (y=280):  죽음 (Death) - 6프레임: 기계적 붕괴, 폭발, 잔해
const BOSS2_SPRITE_MAP = {
    WALK: {
        y: 0, h: 140,
        frames: [
            { x: 0, w: 140 },      // Frame 1: 초기 보행, 검은 증기 분출
            { x: 140, w: 140 },    // Frame 2: 오른발 앞, 백팩 흔들림
            { x: 280, w: 140 },    // Frame 3: 보폭 최대, 기계 귀 메커니즘
            { x: 420, w: 140 },    // Frame 4: 보행 정점, 발 밑 파편
            { x: 560, w: 140 },    // Frame 5: 회복 중, 코트 뒤로 펄럭
            { x: 700, w: 140 }     // Frame 6: 착지 완료, 준비 자세
        ]
    },
    ATTACK: {
        y: 140, h: 140,
        frames: [
            { x: 0, w: 140 },      // Frame 1: 준비, 톱팔 머리 위로
            { x: 140, w: 140 },    // Frame 2: 뒤로 당김, 톱날 기어 회전
            { x: 280, w: 140 },    // Frame 3: 임팩트! 톱날 내리치기, 파편 폭발
            { x: 420, w: 140 },    // Frame 4: 후속 동작, 파편 흩날림
            { x: 560, w: 140 },    // Frame 5: 회복, 톱팔 중립 위치
            { x: 700, w: 140 }     // Frame 6: 복귀, 재공격 준비
        ]
    },
    DEAD: {
        y: 280, h: 140,
        frames: [
            { x: 0, w: 140 },      // Frame 1: 붕괴 시작, 가슴 상처, 피 분출
            { x: 140, w: 140 },    // Frame 2: 무릎 꿇음, 톱팔 끌림
            { x: 280, w: 140 },    // Frame 3: 바닥, 내부 폭발 시작
            { x: 420, w: 140 },    // Frame 4: 대폭발, 부품 날아감
            { x: 560, w: 140 },    // Frame 5: 잔해, 톱날 파편 중앙
            { x: 700, w: 140 }     // Frame 6: 최종, 고대 비석, 해골, 고글
        ]
    }
};

// 보스킹 (청토끼 킹.png) - 3행 6열, 기존 보스와 동일한 y/h/x 구조
