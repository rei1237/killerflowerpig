...
// 보스2 (청토끼 보스2.png) 스프라이트 매핑 - 실제 이미지: 3행 x 7열
// Row 0: 걷기/대기 동작 (WALK)
// Row 1: 공격 동작 (ATTACK)
// Row 2: 사망 동작 (DEAD)
const BOSS2_SPRITE_MAP = {
    WALK: {
        ...
        frames: [
            { x: 0, w: 140 },      // col 1: 서있기
            { x: 140, w: 140 },    // col 2: 왼발 앞
            { x: 280, w: 140 },    // col 3: 서있기
            { x: 420, w: 140 },    // col 4: 오른발 앞
            { x: 560, w: 140 },    // col 5: 서있기
            { x: 700, w: 140 },    // col 6: 왼발 앞
            { x: 840, w: 140 }     // col 7: 서있기
        ]
    },
    ATTACK: {
        y: 140, h: 140,
        frames: [
            { x: 0, w: 140 },      // col 1: 준비
            { x: 140, w: 140 },    // col 2: 돌진 시작
            { x: 280, w: 140 },    // col 3: 공격 찌르기
            { x: 420, w: 140 },    // col 4: 공격 피크
            { x: 560, w: 140 },    // col 5: 돌진 지속
            { x: 700, w: 140 },    // col 6: 복귀 시작
            { x: 840, w: 140 }     // col 7: 복귀 완료
        ]
    },
    DEAD: {
        y: 280, h: 140,
        frames: [
            { x: 0, w: 140 },      // col 1: 피격 반응
            { x: 140, w: 140 },    // col 2: 뒤로 물러남
            { x: 280, w: 140 },    // col 3: 무릎 꿇기
            { x: 420, w: 140 },    // col 4: 바닥으로 쓰러짐
            { x: 560, w: 140 },    // col 5: 바닥에 눕기
            { x: 700, w: 140 },    // col 6: 사망 자세
            { x: 840, w: 140 }     // col 7: 완전 사망
        ]
    }
};

// 보스킹 (청토끼 킹.png) 스프라이트 매핑 - 실제 이미지: 5행 x 6열
// Row 0: 걷기/대기 동작 (WALK)
// Row 1: 공격 동작 (ATTACK)
// Row 2: 사망 동작 (DEAD)
// Row 3: 피격 동작 (HIT)
...
const BOSS_KING_SPRITE_MAP = {
    WALK: {
        y: 0, h: 160,
        frames: [
            { x: 0, w: 160 },      // col 1: 위엄있는 서있기
            { x: 160, w: 160 },    // col 2: 왼발 앞
            { x: 320, w: 160 },    // col 3: 서있기
            { x: 480, w: 160 },    // col 4: 오른발 앞
            { x: 640, w: 160 },    // col 5: 서있기
            { x: 800, w: 160 }     // col 6: 걷기 완료
        ]
    },
    ATTACK: {
        y: 160, h: 160,
        frames: [
            { x: 0, w: 160 },      // col 1: 공격 준비
            { x: 160, w: 160 },    // col 2: 돌진 시작
            { x: 320, w: 160 },    // col 3: 공격 찌르기
            { x: 480, w: 160 },    // col 4: 공격 피크
            { x: 640, w: 160 },    // col 5: 돌진 지속
            { x: 800, w: 160 }     // col 6: 복귀
        ]
    },
    DEAD: {
        y: 320, h: 160,
        frames: [
            { x: 0, w: 160 },      // col 1: 피격 반응
            { x: 160, w: 160 },    // col 2: 뒤로 물러남
            { x: 320, w: 160 },    // col 3: 무릎 꿇기
            { x: 480, w: 160 },    // col 4: 바닥으로 쓰러짐
            { x: 640, w: 160 },    // col 5: 바닥에 눕기
            { x: 800, w: 160 }     // col 6: 완전 사망
        ]
    },
    HIT: {
        y: 480, h: 160,
        frames: [
            { x: 0, w: 160 },      // col 1: 피격 반응 1
            { x: 160, w: 160 },    // col 2: 피격 반응 2
            { x: 320, w: 160 },    // col 3: 피격 반응 3
            { x: 480, w: 160 },    // col 4: 회복 시작
            { x: 640, w: 160 },    // col 5: 회복 중
            { x: 800, w: 160 }     // col 6: 회복 완료
        ]
    }
};
