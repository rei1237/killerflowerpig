...
// 보스2 (청토끼 보스2.png) - 정확한 좌표 매핑
// 이미지 크기: 2400x840px (6열 x 3행, 400x280px 프레임 + 400px 첫 여백)
// Row 1: 걷기 (Walk) - y=0, h=280
// Row 2: 공격 (Attack) - y=280, h=280  
// Row 3: 죽음 (Death) - y=560, h=280
const BOSS2_SPRITE_MAP = {
    WALK: {
        y: 0, h: 280,
        frames: [
            { x: 400, w: 333 },   // Frame 1: (행 1, 열 1)
            { x: 733, w: 333 },   // Frame 2: (행 1, 열 2)
            { x: 1066, w: 333 },  // Frame 3: (행 1, 열 3)
            { x: 1399, w: 333 },  // Frame 4: (행 1, 열 4)
            { x: 1732, w: 333 },  // Frame 5: (행 1, 열 5)
            { x: 2065, w: 333 }   // Frame 6: (행 1, 열 6)
        ]
    },
    ATTACK: {
        y: 280, h: 280,
        frames: [
            { x: 400, w: 333 },   // Frame 1: (행 2, 열 1)
            { x: 733, w: 333 },   // Frame 2: (행 2, 열 2)
            { x: 1066, w: 333 },  // Frame 3: (행 2, 열 3)
            { x: 1399, w: 333 },  // Frame 4: (행 2, 열 4)
            { x: 1732, w: 333 },  // Frame 5: (행 2, 열 5)
            { x: 2065, w: 333 }   // Frame 6: (행 2, 열 6)
        ]
    },
    DEAD: {
        y: 560, h: 280,
        frames: [
            { x: 400, w: 333 },   // Frame 1: (행 3, 열 1)
            { x: 733, w: 333 },   // Frame 2: (행 3, 열 2)
            { x: 1066, w: 333 },  // Frame 3: (행 3, 열 3)
            { x: 1399, w: 333 },  // Frame 4: (행 3, 열 4)
            { x: 1732, w: 333 },  // Frame 5: (행 3, 열 5)
            { x: 2065, w: 333 }   // Frame 6: (행 3, 열 6)
        ]
    }
};
